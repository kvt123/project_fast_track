...
C_SRCS += \
../Middleware/flash/src/flash_middleware.c 

OBJS += \
./Middleware/flash/src/flash_middleware.o 

C_DEPS += \
./Middleware/flash/src/flash_middleware.d 


# Each subdirectory must supply rules for building sources it contributes
Middleware/flash/src/%.o Middleware/flash/src/%.su: ../Middleware/flash/src/%.c Middleware/flash/src/subdir.mk
...
clean: clean-Middleware-2f-flash-2f-src

clean-Middleware-2f-flash-2f-src:
	-$(RM) ./Middleware/flash/src/flash_middleware.d ./Middleware/flash/src/flash_middleware.o ./Middleware/flash/src/flash_middleware.su

.PHONY: clean-Middleware-2f-flash-2f-src
