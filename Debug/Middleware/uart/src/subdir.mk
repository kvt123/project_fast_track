...
C_SRCS += \
../Middleware/uart/src/uart_middleware.c 

OBJS += \
./Middleware/uart/src/uart_middleware.o 

C_DEPS += \
./Middleware/uart/src/uart_middleware.d 


# Each subdirectory must supply rules for building sources it contributes
Middleware/uart/src/%.o Middleware/uart/src/%.su: ../Middleware/uart/src/%.c Middleware/uart/src/subdir.mk
...
clean: clean-Middleware-2f-uart-2f-src

clean-Middleware-2f-uart-2f-src:
	-$(RM) ./Middleware/uart/src/uart_middleware.d ./Middleware/uart/src/uart_middleware.o ./Middleware/uart/src/uart_middleware.su

.PHONY: clean-Middleware-2f-uart-2f-src
